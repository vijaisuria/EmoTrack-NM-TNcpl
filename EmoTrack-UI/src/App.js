...
import './App.scss'; // Assuming you have your CSS styles in App.css
...
function App() {
  ...
  // Effect to load user preference from local storage
  useEffect(() => {
  ...
  // Effect to save user preference in local storage
  useEffect(() => {
